...
**Продакшн на 2026-07-24:** миграции 0001–0004 применены, роли/RLS, инвайты и автоматическое
удаление старых выполненных задач работают. Production собирается из ветки
