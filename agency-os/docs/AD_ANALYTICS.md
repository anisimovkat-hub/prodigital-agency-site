...
- **Фаза B — аналитический UI. СДЕЛАНО (см. раздел выше).** Фильтры (период,
  ...
  за период.
- **Фаза C — панель «Требует внимания». СДЕЛАНО В КОДЕ 2026-08-13.** Сравнение двух
  семидневных периодов: CPA +30%, показы −30%, расход без результата, 14 дней без результата,
  отставание данных более двух дней. Денежные сравнения выполняются внутри одной валюты и
  одинаковой цели; ошибка источника показывается предупреждением, а не нулём.
