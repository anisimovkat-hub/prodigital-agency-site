...
Актуально: 2026-08-20. Список ниже описывает локальные проверенные файлы; для остальных
проектов используется нейтральная заглушка или вручную заданный `projects.logo_url`.
