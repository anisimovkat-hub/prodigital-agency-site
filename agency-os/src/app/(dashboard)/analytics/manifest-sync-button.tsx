...
export function ManifestSyncButton() {
  ...
  return <form action={action} className="mb-3 flex flex-wrap items-center gap-3 rounded-lg border border-neutral-200 bg-white p-3 text-sm">
    <span className="text-neutral-600">ВК и Telegram: ежедневное обновление из таблицы «ПРИН и СОДА». Расход Telegram — фактические списания; резерв объявлений в него не входит.</span>
